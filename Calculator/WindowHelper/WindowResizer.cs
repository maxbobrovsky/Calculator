...
namespace Calculator.WindowHelper
{
    /// <summary>
    ...
    public class WindowResizer
    {
        ...
        /// </summary>
        private WindowDockPosition lastDock = WindowDockPosition.Undocked;
        ...
        /// </summary>
        public Rect CurrentScreenSize => screenSize;
        ...
        public WindowResizer(Window window)
        {
            ...
            this.window.LocationChanged += Window_LocationChanged;
        }
        ...
        private void Window_SizeChanged(object sender, SizeChangedEventArgs e)
        {
            ...
            monitorDpi = VisualTreeHelper.GetDpi(window);
            ...
            var windowTopLeft = new Point(left * monitorDpi.Value.DpiScaleX, top * monitorDpi.Value.DpiScaleX);
            var windowBottomRight = new Point(right * monitorDpi.Value.DpiScaleX, bottom * monitorDpi.Value.DpiScaleX);

            // Check for edges docked
            var edgedTop = windowTopLeft.Y <= (screenSize.Top + edgeTolerance) && windowTopLeft.Y >= (screenSize.Top - edgeTolerance);
            var edgedLeft = windowTopLeft.X <= (screenSize.Left + edgeTolerance) && windowTopLeft.X >= (screenSize.Left - edgeTolerance);
            var edgedBottom = windowBottomRight.Y >= (screenSize.Bottom - edgeTolerance) && windowBottomRight.Y <= (screenSize.Bottom + edgeTolerance);
            var edgedRight = windowBottomRight.X >= (screenSize.Right - edgeTolerance) && windowBottomRight.X <= (screenSize.Right + edgeTolerance);
        ...
        private void WmGetMinMaxInfo(System.IntPtr hwnd, System.IntPtr lParam)
        {
            ...
            if (lParam != IntPtr.Zero)
            {
                ...
                // Set min size
                var minSize = new Point(window.MinWidth * monitorDpi.Value.DpiScaleX, window.MinHeight * monitorDpi.Value.DpiScaleX);
            ...
            CurrentMonitorMargin = new Thickness(
                (lCurrentScreenInfo.RCWork.Left - lCurrentScreenInfo.RCMonitor.Left) / monitorDpi.Value.DpiScaleX,
                (lCurrentScreenInfo.RCWork.Top - lCurrentScreenInfo.RCMonitor.Top) / monitorDpi.Value.DpiScaleY,
                (lCurrentScreenInfo.RCMonitor.Right - lCurrentScreenInfo.RCWork.Right) / monitorDpi.Value.DpiScaleX,
                (lCurrentScreenInfo.RCMonitor.Bottom - lCurrentScreenInfo.RCWork.Bottom) / monitorDpi.Value.DpiScaleY
                );

            // Store new size
            screenSize = new Rect(lCurrentScreenInfo.RCWork.Left, lCurrentScreenInfo.RCWork.Top, currentWidth, currentHeight);
        }
        ...
        public Point GetCursorPosition()
        {
            ...
            // Apply DPI scaling
            return new Point(lMousePosition.X / monitorDpi.Value.DpiScaleX, lMousePosition.Y / monitorDpi.Value.DpiScaleY);
        }
    }
